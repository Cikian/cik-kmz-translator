...
public class RouteFileUtils {
    ...
    private static String getSafePath() {
        ...
        return userHome + File.separator + "temp-kmz" + File.separator;
    }
    ...
    public static String buildKmz(String fileName, KmlInfo kmlInfo, KmlInfo wpmlInfo) {
        ...
        File targetFile = new File(directory, fileName + ".kmz");
    ...
    public static KmlMissionConfig buildKmlMissionConfig(KmlParams kmlParams) {
        ...
        kmlMissionConfig.setPayloadInfo(buildKmlPayloadInfo(kmlParams.getPayloadType(), kmlParams.getSubPayloadType(), kmlParams.getPayloadPosition()));
    ...
    public static KmlPayloadInfo buildKmlPayloadInfo(Integer payloadType, Integer subPayloadType, Integer payloadPosition) {
        KmlPayloadInfo kmlPayloadInfo = new KmlPayloadInfo();
        kmlPayloadInfo.setPayloadEnumValue(String.valueOf(payloadType));
        kmlPayloadInfo.setPayloadSubEnumValue(String.valueOf(subPayloadType));
